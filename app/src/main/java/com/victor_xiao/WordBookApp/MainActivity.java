package com.victor_xiao.WordBookApp;
...
import com.victor_xiao.WordBookApp.wordcontract.Words;
...
public class MainActivity extends AppCompatActivity implements
    ...
    //修改对话框
    private void UpdateDialog(final String strId, final String strWord,
                              final String strMeaning, final String strSample) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String strNewWord = ((EditText)
                                tableLayout.findViewById(R.id.txtWord)).getText().toString();
                        String strNewMeaning = ((EditText)
                                tableLayout.findViewById(R.id.txtMeaning)).getText().toString();
                        String strNewSample = ((EditText)
                                tableLayout.findViewById(R.id.txtSample)).getText().toString();
    ...
    private void SearchDialog() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String txtSearchWord = ((EditText)
                                tableLayout.findViewById(R.id.txtSearchWord)).getText().toString();
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if ("".equals(finalStrWord))
                        Toast.makeText(MainActivity.this,
                                "查询失败，无法添加", Toast.LENGTH_LONG).show();
                    else {
                        WordsDB wordsDB = WordsDB.getWordsDB();
...
//     当用户在单词列表Fragment中单击某个单词时回调此函数
    ...
    @Override
    public void onYouDaoSearch(String strId) {
        WordsDB wordsDB = WordsDB.getWordsDB();
        if (wordsDB != null && strId != null) {

            Words.WordDescription item = wordsDB.getSingleWord(strId);
            if (item != null) {
                YouDaoSearch(item.word);
            }
